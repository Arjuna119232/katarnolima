...
/**
 * KATARNOLIMA RW 05 - Core Script (Pure Online Mode - Versi 2.1)
 */
...
document.addEventListener('DOMContentLoaded', function(){
  ...
  // 3. PUSH NOTIFICATIONS CAPACITOR (MURNI NATIVE - SEPERTI VERSI 2.0)
    ...
    try {
      if (window.Capacitor && window.Capacitor.Plugins && window.Capacitor.Plugins.PushNotifications) {
        ...
        PushNotifications.addListener('registrationError', function(error){ 
          console.warn('⚠️ Error registrasi FCM Native:', error); 
        });
  ...
  setTimeout(setupPushNotifications, 1200);
  ...
  document.querySelectorAll('.back, #backBtn, .btn-back-modern, .btn-back-berita, .btn-back-link').forEach(function(el){ 
